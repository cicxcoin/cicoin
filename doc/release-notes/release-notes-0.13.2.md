Cicoin Core version 0.13.2 is now available from:

  <https://cicoin.org/bin/cicoin-core-0.13.2/>
...
- #8908 `4a974b2` Update cicoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cicoin-tx to create v2 transactions (btcdrak)
