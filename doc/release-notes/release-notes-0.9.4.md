Cicoin Core version 0.9.4 is now available from:

  https://cicoin.org/bin/0.9.4/
...
this update is incompatible with the Cicoin system and could lead to consensus
forks.

Cicoin Core released binaries from https://cicoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cicoin/+archive/ubuntu/cicoin
- A third-party or self-compiled Cicoin Core

upgrade to Cicoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
