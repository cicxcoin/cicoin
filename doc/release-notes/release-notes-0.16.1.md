Cicoin Core version 0.16.1 is now available from:

  <https://cicoincore.org/bin/cicoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting cicoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure cicoind processes are cleaned up when tests end (sdaftuar)
