Cicoin Core version 0.10.4 is now available from:

  <https://cicoin.org/bin/cicoin-core-0.10.4/>
...
- #6953 `43c2789` Split cicoin-tx into its own package
- #6953 `dfe0d4d` Include cicoin-tx binary on Debian/Ubuntu
