Cicoin Core version *0.15.2* is now available from:

  <https://cicoincore.org/bin/cicoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in cicoin-tx (TheBlueMatt)
