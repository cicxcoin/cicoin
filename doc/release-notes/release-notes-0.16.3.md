Cicoin Core version 0.16.3 is now available from:

  <https://cicoincore.org/bin/cicoin-core-0.16.3/>
...
been discovered in Cicoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` cicoinconsensus: invalid flags error should be set to `cicoinconsensus_err` (afk11)
