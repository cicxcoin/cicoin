Cicoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cicoin/files/Cicoin/cicoin-0.5.4/
...
http://gitorious.org/cicoin/cicoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cicoin-Qt notifications under Growl 1.3.
Increase required age of Cicoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCicoin properly when installing Cicoin-Qt over it. (Windows)
