Cicoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cicoin/files/Cicoin/cicoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cicoin
...
New/changed settings (command-line or cicoin.conf file)
--------------------------------------------------------
