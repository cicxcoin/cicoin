...
By default, Cicoin Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that cicoin's trustless model works best if you are
