...
class P2PPermissionsTests(CicoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].cicoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].cicoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
