...
"""Verify that starting cicoin with -h works as expected."""

from test_framework.test_framework import CicoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CicoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cicoin with -h for help text")
        ...
        self.log.info("Start cicoin with -version for version information")
        ...
        self.log.info("Start cicoind with -fakearg to make sure it does not start")
