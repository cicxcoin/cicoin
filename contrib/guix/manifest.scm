...
(define* (make-cicoin-cross-toolchain target
                                  #:key
...
desirable for building Cicoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-cicoin-cross-toolchain "i686-linux-gnu")
       (make-cicoin-cross-toolchain "x86_64-linux-gnu")
       (make-cicoin-cross-toolchain "aarch64-linux-gnu")
       (make-cicoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-cicoin-cross-toolchain "riscv64-linux-gnu"
