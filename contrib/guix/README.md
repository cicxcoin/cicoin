# Bootstrappable Cicoin Core Builds

This directory contains the files necessary to perform bootstrappable Cicoin
Core builds.
...
- 24GB of free disk space on the partition that the Cicoin Core git repository
  resides in
...
For a Cicoin Core depends development environment, simply invoke
...
From the top of a clean Cicoin Core repository:
...
To use dongcarl's substitute server for Cicoin Core builds after having
