...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cicoin repository."
  exit 1
fi
...
# See https://github.com/cicoin/cicoin/issues/16064
...
echo 'When compiling cicoind, run `./configure` in the following way:'
echo
