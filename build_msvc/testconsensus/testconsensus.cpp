...
// cicoin includes.
#include <..\src\script\cicoinconsensus.h>
...
int main()
{
    std::cout << "cicoinconsensus version: " << cicoinconsensus_version() << std::endl;
    ...
    auto op0Result = cicoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, cicoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
