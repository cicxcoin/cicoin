    ...
    mapper(nullptr)
{
    ...
    ui->cicoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cicoinAtStartup);
    ...
    ui->cicoinAtStartup->setToolTip(ui->cicoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->cicoinAtStartup->setText(ui->cicoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openCicoinConfButton->setToolTip(ui->openCicoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CicoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cicoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCicoinConfButton_clicked()
{
