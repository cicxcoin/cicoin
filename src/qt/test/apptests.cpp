...
//! Entry point for CicoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CicoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CicoinGUI tests.
void AppTests::guiTests(CicoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CicoinGUI::consoleShown, this, &AppTests::consoleTests);
