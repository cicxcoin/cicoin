...
/* A AEAD class for ChaCha20-Poly1305@cicoin.
 *
 ...
 *
 * The chacha20-poly1305@cicoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@cicoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@cicoin are relatively fast in
